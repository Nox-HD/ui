...
const Element = ({ Award }) => {
  ...
  const [currents2, setCurrents2] = useState(1);
  ...
  return (
    <div className="flex flex-col justify-center items-center h-full w-full">
      {!isMobile ? (
        <div>
          <motion.div className="flex gap-x-14">
      ...
      <div
        className="overflow-hidden w-full pt-10 pb-10"
        style={{
          width: '100%',
          maskImage:
        ...
        >
          {Award.map((award, index) => (
            <motion.div
              key={index}
              className={classNames(
                'flex-none w-full text-center text-xl px-14 md:px-48',
      ...
      <div className="flex justify-center content-center md:pt-10 group [mask-image:linear-gradient(to_right,rgba(0,0,0,0),rgba(0,0,0,1)_50%,rgba(0,0,0,1)_50%,rgba(0,0,0,0))]">
        <motion.div
          className="flex w-full"
