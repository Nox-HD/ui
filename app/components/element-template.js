    ...
    <div>
        ...
        <Tabs defaultValue="preview" className="w-full">
          ...
          <TabsContent className="flex  m-auto overflow-hidden" value="preview">
            <motion.div
              ...
              className="border min-h-[25vw] mt-5 min-w-full rounded-xl overflow  flex flex-col justify-center items-center content-center overflow-hidden"
            >
              {element}
            </motion.div>
          </TabsContent>
      ...
      <div className="pt-10">
        ...
        <div className="relative">
          ...
          <button
            className="p-2 absolute right-0 md:right-3 top-3 hover:bg-[#3f3f46] transition-colors duration-200 rounded-sm"
            onClick={async () => {
        ...
        {Csscodes && (
          <div>
            ...
            <div className="relative">
              ...
              <button
                className="p-2 absolute  md:right-3 right-0 top-3 hover:bg-[#3f3f46] transition-colors duration-200 rounded-sm"
                onClick={async () => {
