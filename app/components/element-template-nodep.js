        ...
        <div className='pt-10'> 
            ...
            {Csscodes && (<div>
              ...
              <div className='relative'>
                  ...
                  <button className='p-2 absolute right-3 top-3 hover:bg-[#3f3f46] transition-colors duration-200 rounded-sm' onClick={async () => {navigator.clipboard.writeText(csscode)}}>
