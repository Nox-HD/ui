...
const InfiniteCarousel = () => {
  return (
    <div>
        <TemplateNoCentre heading={"Infinite Tunnel"} 
                  subtitle={"Dynamic Shader-Based Infinite Tunnel Component"} 
                  element={<Element text={"The Next Generation"}/>} 
                  tabcode={`import React from 'react'
import InfiniteTunnel from '@/components/infinite-tunnel/infinitetunnel'

const App = () => {
  return (
    <div>
      <InfiniteTunnel text={"The Next Generation"} />
    </div>
  )
}
...
export default InfiniteTunnel;`} 
                  jsxlocation={"components/infinite-tunnel/infinitetunnel.jsx"} 
                  csslocation={""}
        />
    </div>
  );
