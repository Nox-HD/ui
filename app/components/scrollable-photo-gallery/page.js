  ...
  return (
    <div>
      <article className="pb-5 prose prose-lg prose-slate prose-invert">
        ...
        <p>
          Effortlessly showcase your photos in a scroll-driven gallery built
          with Lenis.
        </p>
      </article>
        ...
        <Tabs defaultValue="preview" className="w-full">
          ...
          <TabsContent className="flex m-auto overflow-hidden " value="preview">
            <motion.div
              ...
              className="bg-black border min-h-[5vw] min-w-full rounded-xl mt-5 overflow overflow-auto flex flex-col justify-center items-center content-center"
            >
              <Element />
            </motion.div>
          </TabsContent>
          ...
          >
            <motion.div
              ...
              animate={{ y: 0, opacity: 1 }}
              transition={{ duration: 0.3 }}
              className="min-w-full mt-5 overflow-auto border rounded-xl overflow codes"
            >
              <SyntaxHighlighter
                className="h-full overflow-auto codes overflow max-h-[30rem]"
                language="javascript"
                style={atomOneDark}
                customStyle={{
      ...
      <div className="pt-10">
        ...
        >
          ...
          <p className="text-xs font-semibold">
            This component needs the Lenis smooth scroll library to be set up on
            the page where you want to use it.
          </p>
        </div>
        <hr className="pb-5 solid"></hr>
        <h2 className="pb-3 text-xl font-bold">Install dependencies</h2>
        <div className="relative">
          <SyntaxHighlighter
            className="overflow-auto codes overflow"
            language="powershell"
            style={atomOneDark}
            customStyle={{
              backgroundColor: "#18181b",
          ...
          <button
            ...
            onClick={async () => {
              navigator.clipboard.writeText("npm i gsap lenis"),
                setCopied3(true),
                setTimeout(() => {
                  setCopied3(false);
                }, 1500);
        ...
        {Jsxcodes && (
          <div>
            ...
            <div className="pb-2">
              components/scrollable-photo-gallery/scrollablephotogallery.jsx
            </div>
            <div className="relative">
              <SyntaxHighlighter
                id="maincode"
                className="overflow-auto codes overflow max-h-96"
                language="javascript"
                style={atomOneDark}
                customStyle={{
                  backgroundColor: "#18181b",
