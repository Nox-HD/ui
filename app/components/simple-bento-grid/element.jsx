    ...
    <div className="w-full h-screen p-10">
      <div className="grid md:grid-cols-5 md:grid-rows-[10] h-full gap-x-6 gap-y-6">
          ...
          <Link href="#">
            <motion.div whileHover="hover" className="absolute left-7 bottom-7 font-bold">
              ...
              <motion.div
                ...
                className="bg-white h-0.5 w-0.5 origin-left absolute"
              ></motion.div>
            </motion.div>
          </Link>
        </div>
        ...
        <div className="md:col-span-2 md:row-span-3 rounded-2xl overflow-hidden relative bg-[radial-gradient(circle_at_44px_44px,_#00005B_10%,_#000_120%)]">
          ...
          <div className="text-6xl absolute font-bold bottom-11 left-7">55%</div>
          <div className="absolute bottom-6 opacity-75 left-7">Faster Coding</div>
        </div>
        ...
        <div className="md:col-span-3 overflow-hidden relative md:row-span-3 w-full h-full rounded-2xl">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide absolute opacity-75 top-[44px] left-28 lucide-chrome">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide absolute opacity-75 top-[44px] left-40 lucide-cast">
            <path d="M2 8V6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-6" />
            <path d="M2 12a9 9 0 0 1 8 8" />
            <path d="M2 16a5 5 0 0 1 4 4" />
            <line x1="2" x2="2.01" y1="20" y2="20" />
          </svg>
          <div className="text-4xl absolute font-bold bottom-7 w-96 left-7">Coding. Redefined.</div>
        </div>
      </div>
    </div>
  );
