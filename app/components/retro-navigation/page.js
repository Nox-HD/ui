...
const AwardsCarousel = () => {
  return (
    <div>
      <TemplateNoCentre
        heading={"Retro Navigation"}
        subtitle={
          "Navigation Menu that Blends Retro Aesthetics with Modern Design"
        }
        element={
          <Menu
            menuItems={[
...
import RetroNavigation from '@/components/retro-navigation/retronavigation'
...
export default function RetroNavigation({ menuItems }) {
...
`}
        jsxlocation={"components/retro-navigation/retronavigation.jsx"}
        csslocation={""}
      />
    </div>
  );
