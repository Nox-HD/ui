...
const Header = () => {
  return (
    <div className='min-w-full min-h-20 md:min-h-14 bg-black/50 backdrop-blur-3xl grid md:grid-cols-6 fixed z-50'>
        ...
        <div className='md:col-span-3 flex content-center items-center space-x-5 text-sm invisible md:visible absolute md:relative' >
            <Link className='text-neutral-400 transition-colors duration-150 hover:text-white' href='/components/introduction'> Documentation </Link>
            <Link className='text-neutral-400 transition-colors duration-150 hover:text-white' href='/components'> Components </Link>
            <Link className='text-neutral-400 transition-colors duration-150 hover:text-white' target='_blank' href='https://noxhd.com/#contact'> Contact </Link>
        </div>
